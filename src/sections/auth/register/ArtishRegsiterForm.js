...
const ArtishRegsiterForm = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setErrors, setStatus, setSubmitting }) => {
            console.log(values, errors, "mayur")
            fetch('http://localhost:3005/api/v1/artist/auth/sign-up', {
                method: 'POST',
                body: JSON.stringify({
                        ...
                        {/* <Grid container justifyContent="center" alignItems="center">
                            ...
                            <Grid item md={6} sm={6} xs={12}>
                                <TextField
                                    ...
                                    selected="Artist"
                                >
                                    <MenuItem value="Artist" selected>Artist</MenuItem>
...
export default ArtishRegsiterForm