...
export const SelectSignupModel = () => {
            ...
            >
                ...
                <DialogContent dividers>
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs="auto">
                            <Item>
                                <Button variant="outlined" onClick={() => { navigate("/signup"); }}>Fan Registration</Button>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs="auto">
                            <Item>
                                <Button variant="outlined" onClick={() => { navigate("/artist-signup"); }}>Artist Registration</Button>
